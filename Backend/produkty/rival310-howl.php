...
$sql = "SELECT * FROM produkty WHERE id_produktu = 4";
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form action="#" method="POST">
                                ...
                                <button name="id" value="4" type="submit" class="btn btn-primary buttonik">Do koszyka</button>
                                </div>
                        </form>
                        <?php
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="addOpinion.php" method="POST">
                            ...
                            <button type="submit" name="id" class="btn btn-primary" value="4">Prześlij</button>'; endif; ?>
                        </form>
                    </div>
                </div>
            </div>
