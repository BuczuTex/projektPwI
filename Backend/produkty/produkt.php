...
session_start();
require('../db.php');
$sql = "SELECT * FROM produkty WHERE id_produktu=".$_GET['id'];
$row = $pdo->query($sql) -> fetch(PDO::FETCH_ASSOC);
$_SESSION['cena'] = $row['cena'];
$_SESSION['cena_promocyjna'] = $row['cena_promocyjna'];
$_SESSION['id_produktu'] = $_GET['id'];
?>
<!DOCTYPE html>
<html lang="pl">
    <head>
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form action="addToCart.php" method="GET">
                                ...
                                <?php for($i = 1; $i <= $row['ilosc']; $i++) echo '<option>'.$i.'</option>'; ?>
                                </select>
                                <button type="submit" class="btn btn-primary buttonik">Do koszyka</button>
                                </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="addOpinion.php" method="POST">
                            ...
                            <button type="submit" name="id" class="btn btn-primary" value="1">Prześlij</button>'; endif; ?>
                        </form>
                    </div>
                </div>
            </div>
