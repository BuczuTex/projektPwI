...
$sql = "SELECT * FROM produkty WHERE id_produktu = 3";
        ...
        <nav>
          ...
          <div class="content">
            <div class="zdjecie">
              <div class="card">
                  <div class="card-body">
                  <img class="zd-prod" src=<?php echo '"../'.$row['zdjecie'].'"'; ?> height="294" width="300" alt=<?php echo '"'.$row['alt'].'"';?>>
                    </div>
                  </div>
              </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form action="#" method="POST">
                                ...
                                <button name="id" value="3" type="submit" class="btn btn-primary buttonik">Do koszyka</button>
                                </div>
                        </form>
                        <?php
                ...
                <div class="card">
                    ...
                    <h5>Opinie użytkowników</h5>
                        ...
                        <form action="addOpinion.php" method="POST">
                            ...
                            <button type="submit" name="id" class="btn btn-primary" value="3">Prześlij</button>'; endif; ?>
                        </form>
                    </div>
                </div>
            </div>
